...
if (temperature >= 25 && humudity >= 70) {
  console.log("더운 날씨입니다");
} else if (temperature >= 25 && humudity < 70) {
...
if (userAge1 >= 21 && hasLicense && hasInsurance) {
  console.log("완벽한 운전자");
} else if (userAge1 >= 21 && hasLicense) {
  console.log("운전 가능");
} else {
  console.log("운전 불가");
}
...
if (!isActive) {
  ...
  if (userType === "premium" && userPoint >= 2000) {
    console.log("VIP 등급");
  } else if (userType === "premium" && userPoint >= 1000) {
    console.log("프리미엄 등급");
  } else if (userType === "regular" && userPoint >= 1000) {
    console.log("일반 등급");
  } else {
    console.log("신규 등급");
  }
