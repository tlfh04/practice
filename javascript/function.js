...
function greet(massage) {
  console.log(`안녕하세요, [${massage}]님!`);
}

// 화살표 함수 정의 코드
const greetArrow = (massage) => console.log(`안녕하세요, [${massage}]님!`);
...
// 화살표 함수 정의 코드
const squareArrow = (num1) => num1 * num1;
...
// 함수 선언식 정의 코드
function printFromOne(num1) {
  for (let i = 1; i <= num1; i++) {
    console.log(i);
  }
}
// 화살표 함수 정의 코드
const printFromOneArrow = (num1) => {
  for (let i = 1; i <= num1; i++) {
    console.log(i);
  }
};
