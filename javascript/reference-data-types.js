...
// TODO: 배열 생성과 길이 실습
// 변수 days에 "월", "화", "수"를 담은 배열을 할당하고 출,력한다
...
letters.push("Z");
console.log(letters);
let pop_letters = letters.pop();
console.log(pop_letters);
console.log(letters);
...
scores1.push(30);
console.log(scores1);
let pop_scores = scores1.pop();
console.log(pop_scores);
console.log(scores1);
...
for (memolist1 of memoList) {
  if (memolist1["isDone"] === false) {
    console.log(memolist1);
  }
}
/*
{ content: "오늘 할 일", isDone: false }
